...
<div class="bg-whisper grid grid-col-12 md:gap-x-16 min-h-screen">
  <Snackbar />
  <Navbar />
  <main
    class="col-span-12 md:col-span-8 md:col-start-4 md:pt-20 lg:col-span-6 lg:col-start-5 px-4 pt-4"
  >
    <h2>Invoice Details</h2>
    <p class="mb-8">This information gets inclued on each invoice.</p>
    ...
    <div class="col-span-6">
      ...
      <p>This information is used to access your account.</p>
    </div>
