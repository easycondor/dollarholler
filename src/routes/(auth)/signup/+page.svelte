...
<form>
  <div class="field">
    <label for="fullName" class="text-goldenFizz">fullName</label>
  ...
  <div class="field">
    <label for="confirmPassword" class="text-goldenFizz">Password</label>
    <input type="password" name="confirmPassword" id="confirmPassword" required />
  </div>
  <button type="submit" class="sign-button">Count me in!</button>
